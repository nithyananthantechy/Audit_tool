    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-6 text-white text-center bg-slate-950">
      ...
      <div className="space-y-4 animate-in fade-in slide-in-from-bottom-8 duration-700 fill-mode-forwards">
        ...
        <div className="pt-12 flex flex-col items-center gap-4">
          ...
          <p className="text-slate-400 text-sm font-medium italic">Preparing your GRC Compliance Workspace...</p>
          <button
            onClick={onComplete}
            className="px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold uppercase tracking-widest transition-all shadow-lg shadow-blue-500/20"
          >
            Enter Workspace Now
          </button>
        </div>
